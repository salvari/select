...
\medskip
\item{$\bullet$} $I_{R1}$ = \underbar{25 mA} ; Direction = {\it to the left}
\vskip 5pt
\item{$\bullet$} $I_{R4}$ = \underbar{55 mA} ; Direction = {\it to the left}
\vskip 5pt
\item{$\bullet$} $I_{R5}$ = \underbar{50 mA} ; Direction = {\it down}
\vskip 5pt
\item{$\bullet$} $I_{R7}$ = \underbar{105 mA} ; Direction = {\it up}
\medskip
