...
One of the fundamental principles of calculus is a process called {\it integration}.  This principle is important to understand because it is manifested in the behavior of capacitance.  Thankfully, there are more familiar physical systems which also manifest the process of integration, making it easier to comprehend.
...
Challenge question: can you think of a way we could exploit the similarity of capacitive voltage/current integration to {\it simulate} the behavior of a water tank's filling, or any other physical process described by the same mathematical relationship?
...
%INDEX% Integration, with capacitor
