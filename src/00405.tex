...
\item{5.} Mathematically analyze the circuit, solving for all values of voltage, current, etc.
\item{6.} Carefully measure those quantities, to verify the accuracy of your analysis.
...
Avoid very high and very low resistor values, to avoid measurement errors caused by meter "loading".  I recommend resistors between 1 k$\Omega$ and 100 k$\Omega$, unless, of course, the purpose of the circuit is to illustrate the effects of meter loading!
...
%INDEX% Don't just sit there -- Build something!! (DC circuits)
